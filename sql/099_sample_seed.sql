...
-- Refresh analytics materialized views so simple numeric SQL loading leaves
-- dashboard/reporting views populated after synthetic seed data is inserted.
DO $refresh_seed_analytics$
DECLARE
  view_name text;
BEGIN
  FOREACH view_name IN ARRAY ARRAY[
    'analytics_inventory_pipeline_mv',
    'analytics_sales_margin_mv',
    'analytics_sales_margin_period_mv',
